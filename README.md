...
```bash
composer require ros/filament-release-notes
```
...
```php
use Ros\FilamentReleaseNotes\FilamentReleaseNotesPlugin;
...
4. Ejecuta `composer require ros/filament-release-notes` en el proyecto consumidor.
